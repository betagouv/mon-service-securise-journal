...
INSERT INTO journal_mss.donnees_completude_premiere_fois_80 (
                id_service,
...
SELECT a.id_service,
       ...
       b.indice_cyber,
       a.date
FROM tout_sauf_indice a
JOIN indice b on a.id_evenement = b.id_evenement
