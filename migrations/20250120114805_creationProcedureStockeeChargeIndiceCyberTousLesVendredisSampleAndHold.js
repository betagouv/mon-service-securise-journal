...
AS $$
    ...
    WITH dates_avec_indices AS (
      SELECT 
          ...
          ids.id_service,
          indice
      FROM (SELECT distinct id_service from journal_mss.donnees_indice_cyber_hebdomadaire) ids
...
exports.down = knex => knex.raw(`
    DROP PROCEDURE IF EXISTS journal_mss.charge_donnees_indice_cyber_tous_les_vendredis_sample_and_hold();
`)
